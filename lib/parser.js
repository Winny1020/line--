 ...
 * @returns {{type: '支出'|'收入', category: string, item: string, amount: number} | null}
 */
function parseExpenseMessage(rawText, resolveCategory = guessCategory) {
  ...
  return { type, category, item, amount };
}
