...
const HEADER = ["日期時間", "類型", "分類", "項目", "金額", "UserId"];
...
async function appendExpense({ type, category, item, amount, userId }) {
  ...
  await sheets.spreadsheets.values.append({
    ...
    requestBody: { values: [[timestamp, type, category, item, amount, userId]] },
  });
  return { timestamp };
}
...
module.exports = { appendExpense, getSummary, deleteLastExpense, getItemCategoryHistory };
